...
//==================区域
    ...
    //添加商家的区域信息
    Integer addArea(@Param("shopId") Integer shopId,@Param("floorId") Integer floorId,@Param("area") Integer area);
    ...
    List<AreaForm> selectListArea();
    //单个查询桌子
    Table selectOne (@Param("shopId") Integer shopId,@Param("tableId") Integer tableId);
    //修改数据
    Integer updagetable(@Param("floor") Integer floor,
                        @Param("area") Integer area,
                        @Param("specification") Integer specification,
                        @Param("id") Integer id);

    Integer deletetable(@Param("shopID") Integer shopId,
                        @Param("tableId")Integer tableId);

    //以tableId查询tableName
    String gettableName(Integer tableId);

    List<TableGross> selecttablespecification(@Param("shopId")Integer shopId);
}
