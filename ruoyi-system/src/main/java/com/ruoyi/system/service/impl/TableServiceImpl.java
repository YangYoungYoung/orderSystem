...
import com.ruoyi.system.form.AreaForm;
...
public class TableServiceImpl implements TableService {
    ...
    @Override
    public List<TableGross> selecttablespecification(Integer shopId){
        return tableMapper.selecttablespecification(shopId);
    }
    ...
    @Override
    public Integer addArea(Integer shopId, Integer floorId, Integer area) {
    ...
    @Override
    public List<AreaForm> selectListArea() {
        return tableMapper.selectListArea();
    }

    //单个修改数据查询
    @Override
    public  Table selectOne(Integer shopId, Integer tableId){
        return tableMapper.selectOne(shopId,tableId);
    }

    //数据修改
    @Override
    public Integer updagetable(Integer floor, Integer area,Integer specification,Integer id){
        return tableMapper.updagetable(floor,area,specification,id);
    }
    @Override
    public Integer deletetable (Integer shopId,Integer tableid){
        return tableMapper.deletetable(shopId,tableid);
    }
