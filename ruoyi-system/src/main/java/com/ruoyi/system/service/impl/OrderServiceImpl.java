...
public class OrderServiceImpl implements IOrderService {
	...
	@Override
	public List<Order> findAll(Integer shopId) {
		return orderMapper.findAll(shopId);
	}
	@Override
	public Integer findNewOrder(Integer shopId) {
		return orderMapper.findNewOrder(shopId);
	}

	@Override
	public Integer updateDishStatus(Integer dishStatus, Integer id) {
		return orderMapper.updateDishStatus(dishStatus,id);
	}
	...
	@Override
	public Integer printEcho(String orderId, Integer shopId) {
		return orderMapper.printEcho(orderId,shopId);
	}

	@Override
	public Integer printEchoPart(Integer dishId,String orderId, Integer shopId) {
		return orderMapper.printEchoPart(dishId,orderId,shopId);
	}
