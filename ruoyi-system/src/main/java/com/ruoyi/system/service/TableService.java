...
public interface TableService {
    ...
    List<TableGross> selecttablespecification(Integer shopId);

    //==================区域===========================

    //添加商家的区域信息
    Integer addArea(Integer shopId,Integer floorId,Integer area);
    ...
    Integer updagetable(Integer floor, Integer area, Integer specification, Integer id);

    Integer deletetable(Integer shopId, Integer tableId);

    Table selectOne(Integer shopId, Integer tableId);
}
