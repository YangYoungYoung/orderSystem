...
public class GetOpenIdController{
    ...
    public Map decodeUserInfo(HttpServletRequest request) {
        ...
        JSONObject jsonObject= StringToObject.StringToJSon(request);
        String code=jsonObject.getString("code");
        Integer shopId=Integer.parseInt(jsonObject.getString("shopId"));
...
//        String wxspSecret = "6d777f9bceb827b31934faefa1e69f2f";
        ...
        //请求参数
        String params = "appid=" + shop.getAppId() + "&secret=" + shop.getSecret() + "&js_code=" + code + "&grant_type=authorization_code";
        //发送请求
