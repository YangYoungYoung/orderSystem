...
//----------------------------------------------第三方支付-------------------------------------------------------------------
    ...
    public Result payMnet(HttpServletRequest request) {
        ...
        jsonObject.put("appid", shop.getAppId());
        jsonObject.put("orgNo", shop.getOrgNo());
        jsonObject.put("mercId", shop.getMercId());
        jsonObject.put("trmNo", shop.getTrmNo());
        ...
        try {
            String str = HttpUtil.post("http://gateway.starpos.com.cn/adpweb/ehpspos3/pubSigPay.json", json);
